...
const S_Profile_New = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-12 p-10 bg-gradient-to-r from-purple-200 via-blue-500 to-purple-200 text-white shadow-2xl rounded-3xl">
